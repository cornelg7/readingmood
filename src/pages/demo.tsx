...
const Demo: NextPage = () => {
  ...
  return (
    <Layout handleClick={() => handleSignUp()} authText="Sign Up" name="none">
      <main className="flex flex-col items-center justify-center bg-gradient-to-b from-[#112331] to-[#091B2A]">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:gap-8 flex-wrap-reverse">
            <div
              className="flex max-w-lg flex-col gap-4 rounded-xl bg-white/5 p-4 text-white hover:bg-white/10 order-2 md:order-1"
            >
              <img className="rounded-xl" src="/read-and-listen.png"  alt={'read and listen'}/>
            </div>
            <div
              className="flex max-w-lg flex-col gap-4 rounded-xl bg-white/5 p-4 text-white hover:bg-white/10 order-1 md:order-2"
            >
